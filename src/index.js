...
// 路由
import indexData from '@views/indexData'; //首页数据
import userManage from '@views/userManage'; //用户管理
import fundsManage from '@views/fundsManage'; //资金管理
import debtManage from '@views/debtManage'; //债权管理
import contentManage from '@views/contentManage'; //内容管理
